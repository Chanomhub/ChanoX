...
const Home: React.FC = () => {
    ...
    const renderFilterModal = () => (
        <div className={`fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center md:items-start md:mt-16 transition-opacity ${showFilterModal ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
